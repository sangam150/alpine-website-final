        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Choose your next step and let us help you achieve your
            ...
            {ctaOptions.map((option) => (
              ...
              >
                <div className="text-center">
                  <div
                    className={`text-4xl mb-4 ${option.bgColor} w-16 h-16 rounded-full flex items-center justify-center mx-auto group-hover:scale-110 transition-transform duration-300`}
                  >
                    {option.icon}
                  </div>
                  ...
                  <div
                    className={`inline-flex items-center justify-center px-4 py-2 bg-gradient-to-r ${option.color} text-white text-sm font-medium rounded-lg group-hover:scale-105 transition-transform duration-200`}
                  >
                    Get Started
                  </div>
                </div>
          ...
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 md:p-12 text-white">
            <div className="text-center">
              ...
              <p className="text-blue-100 mb-8 max-w-2xl mx-auto">
                ...
                study abroad dreams with Alpine Education. Your journey to
