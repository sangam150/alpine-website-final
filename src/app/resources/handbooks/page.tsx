...
export default function HandbooksPage() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-blue-50 to-white px-4 py-16 text-center">
      ...
      <p className="text-gray-700 mb-6">Downloadable handbooks and guides coming soon. Personalized PDFs based on your study preferences will be available here!</p>
