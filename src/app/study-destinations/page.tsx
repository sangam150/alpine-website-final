...
export const metadata: Metadata = {
  title: 'Study Destinations - Alpine Education | Top Countries for International Students',
  description: 'Explore top study destinations including Australia, UK, Canada, USA, Germany, and more. Get expert guidance on universities, courses, and visa requirements.',
  keywords: 'study abroad destinations, Australia, UK, Canada, USA, Germany, international universities, student visa',
  openGraph: {
    title: 'Study Destinations - Alpine Education',
    description: 'Explore top study destinations with expert guidance on universities and visa requirements.',
    type: 'website',
  },
};
                    ...
                    <CardContent className="p-6">
                      ...
                      <div className="mb-6">
                        ...
                        <div className="flex flex-wrap gap-1">
                          {destination.popularCourses.slice(0, 3).map((course) => (
                      ...
                      <div className="mb-6">
                        ...
                        <ul className="space-y-1">
                          {destination.pros.map((pro) => (
                            <li key={pro} className="flex items-center text-sm text-gray-600">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Studying abroad offers unique opportunities for personal growth, career advancement, and global perspective.
              </p>
            </motion.div>
          </div>
            ...
            {[
              {
                ...
                description: 'Experience different cultures and develop international understanding'
              },
              {
                icon: GraduationCap,
                title: 'Quality Education',
                description: 'Access world-class universities and cutting-edge research facilities'
              },
              {
                icon: Users,
                title: 'Networking',
              ...
              },
              {
                ...
                description: 'Enhanced job prospects with international experience and qualifications'
              }
            ].map((benefit, index) => (
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-blue-100 mb-8">
              Get expert guidance on selecting the perfect study destination for your goals and aspirations.
            </p>
