          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="text-center border-0 shadow-lg hover:shadow-xl transition-shadow duration-300">
              <CardHeader className="pb-4">
                ...
                <CardTitle className="text-xl">3000+ Students</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="text-center border-0 shadow-lg hover:shadow-xl transition-shadow duration-300">
              <CardHeader className="pb-4">
                ...
                <CardTitle className="text-xl">95% Success Rate</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600">
                  High visa approval rate with expert guidance
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center border-0 shadow-lg hover:shadow-xl transition-shadow duration-300">
              <CardHeader className="pb-4">
                ...
                <CardTitle className="text-xl">12+ Countries</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600">
                  Study destinations across the globe
                </p>
              </CardContent>
            </Card>
