...
export const metadata = {
  title: 'Scholarships - Alpine Education',
  description: 'Find and apply for scholarships for your study abroad journey with Alpine Education.'
};
export default function ScholarshipsPage() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-blue-50 to-white px-4 py-16 text-center">
      ...
      <h1 className="text-3xl font-bold text-blue-700 mb-2">Scholarships</h1>
      <p className="text-gray-700 mb-6">Explore exclusive scholarships and financial aid opportunities. Listings and application tips coming soon!</p>
