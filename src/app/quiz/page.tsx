      ...
      <div className="min-h-screen bg-gray-50 py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-blue-50 p-4 rounded-lg">
                    ...
                    <p className="text-blue-700">{recommendation.timeline}</p>
                  </div>
                  <div className="bg-green-50 p-4 rounded-lg">
                    <h4 className="font-semibold text-green-900">Estimated Cost</h4>
                    <p className="text-green-700">{recommendation.estimatedCost}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="shadow-lg">
              <CardHeader>
                <CardTitle className="text-2xl">Get Your Handbook</CardTitle>
                <CardDescription>
                  Receive a detailed PDF guide with your personalized study abroad plan
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div>
                ...
                <Button
                  onClick={generatePDF}
                  disabled={!email || isGeneratingPDF}
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          ...
          <p className="text-lg text-gray-600">
            Answer a few questions to get personalized recommendations for your study abroad journey.
          </p>
        </div>
